...
app.init = function(middleware){
  ...
  var fn = router.middleware(function(app){ self.routes = app; });
  ...
  this.remove = router.remove.bind(router);
  this.match = router.match.bind(router);
  this.lookup = router.lookup.bind(router);
};
